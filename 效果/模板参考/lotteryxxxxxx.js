...
* @Last Modified time: 2017-08-24 14:16:15
*/
                  ...
                  var browser=navigator.appName 
                    ...
                    if(browser=="Microsoft Internet Explorer")
                     ...
                     if(browser!="Microsoft Internet Explorer" && trim_Version!="MSIE9.0") {
                        ...
                        _private.addRule('@' + _private.prefix + 'keyframes '+ classes['borderLight'] , '0% {background:url(ossweb-img/sel.png) no-repeat;opacity: 0.5;transform: scale(1);}100% {background:url(ossweb-img/sel.png) no-repeat;opacity: 0.9;transform: scale(1.05);}');
                    }
                    ...
                    //不可点击状态的抽奖按钮class初始化
                    var disableBtn = extendObj(startBtn,{cursor:'normal',background:'none'});
                ...
                if(config.r){
                 ...
                 var browser=navigator.appName 
                    ...
                    if(browser=="Microsoft Internet Explorer") {
                        ...
                        console.log(id);
                            moveBox.style="transform: rotateZ("+ ((360-step[id]) + 360 * 10)+"deg); transition:transform 5s cubic-bezier(0.35, -0.005, 0.565, 1.005) 0s;";
                           // 动画结束时事件
                           moveBox.addEventListener("transitionend", function() {
                           moveBox.style="transform: rotateZ("+ ((360-step[id]))+"deg);";
