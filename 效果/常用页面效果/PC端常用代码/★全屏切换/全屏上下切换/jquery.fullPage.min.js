...
(function(b) {
    b.fn.fullpage = function(c) {
        function Z(a) {
            if (c.autoScrolling && !L(a.target)) {
                a.preventDefault();
                var e = a.originalEvent;
                a = b(".section.active");
                if (!t && !s) if (e = M(e), w = e.y, z = e.x, a.find(".slides").length && Math.abs(A - z) > Math.abs(x - w)) Math.abs(A - z) > b(window).width() / 100 * c.touchSensitivity && (A > z ? a.find(".controlArrow.next:visible").trigger("click") :a.find(".controlArrow.prev:visible").trigger("click")); else if (a = a.find(".slides").length ? a.find(".slide.active").find(".scrollable") :a.find(".scrollable"), 
                Math.abs(x - w) > b(window).height() / 100 * c.touchSensitivity) if (x > w) if (0 < a.length) if (B("bottom", a)) b.fn.fullpage.moveSectionDown(); else return !0; else b.fn.fullpage.moveSectionDown(); else if (w > x) if (0 < a.length) if (B("top", a)) b.fn.fullpage.moveSectionUp(); else return !0; else b.fn.fullpage.moveSectionUp();
            }
        }
        function L(a, e) {
            e = e || 0;
        ...
        function $(a) {
            c.autoScrolling && (a = M(a.originalEvent), x = a.y, A = a.x);
        }
        function n(a) {
            if (c.autoScrolling) {
                a = window.event || a;
                ...
                var e;
                e = b(".section.active");
                if (!t) if (e = e.find(".slides").length ? e.find(".slide.active").find(".scrollable") :e.find(".scrollable"), 
                0 > a) if (0 < e.length) if (B("bottom", e)) b.fn.fullpage.moveSectionDown(); else return !0; else b.fn.fullpage.moveSectionDown(); else if (0 < e.length) if (B("top", e)) b.fn.fullpage.moveSectionUp(); else return !0; else b.fn.fullpage.moveSectionUp();
                return !1;
            }
        }
        function p(a, e, d) {
            ...
            if ("undefined" !== typeof g) {
                var g = g.top, l = G(a), q = a.data("anchor"), H = a.index(".section"), k = a.find(".slide.active"), r = b(".section.active"), s = r.index(".section") + 1, D = C;
                if (k.length) var n = k.data("anchor"), p = k.index();
                if (c.autoScrolling && c.continuousVertical && "undefined" !== typeof d && (!d && "up" == l || d && "down" == l)) {
                    d ? b(".section.active").before(r.nextAll(".section")) :b(".section.active").after(r.prevAll(".section").get().reverse());
                    y(b(".section.active").position().top);
                    var h = r, g = a.position(), g = g.top, l = G(a);
                }
                a.addClass("active").siblings().removeClass("active");
                t = !0;
                "undefined" !== typeof q && N(p, n, q);
                c.autoScrolling ? (f.top = -g, a = u.selector) :(f.scrollTop = g, a = "html, body");
                var m = function() {
                    h && h.length && (d ? b(".section:first").before(h) :b(".section:last").after(h), 
                    y(b(".section.active").position().top));
                };
                c.css3 && c.autoScrolling ? (b.isFunction(c.onLeave) && !D && c.onLeave.call(this, s, l), 
                O("translate3d(0px, -" + g + "px, 0px)", !0), setTimeout(function() {
                    m();
                    b.isFunction(c.afterLoad) && !D && c.afterLoad.call(this, q, H + 1);
                    setTimeout(function() {
                        t = !1;
                        b.isFunction(e) && e.call(this);
                    }, P);
                }, c.scrollingSpeed)) :(b.isFunction(c.onLeave) && !D && c.onLeave.call(this, s, l), 
                b(a).animate(f, c.scrollingSpeed, c.easing, function() {
                    m();
                    b.isFunction(c.afterLoad) && !D && c.afterLoad.call(this, q, H + 1);
                    setTimeout(function() {
                        t = !1;
                ...
                v = q;
                c.autoScrolling && (Q(q), R(q, H));
            }
        }
        function h(a, e) {
            var d = e.position(), f = a.find(".slidesContainer").parent(), g = e.index(), l = a.closest(".section"), q = l.index(".section"), h = l.data("anchor"), k = l.find(".fullPage-slidesNav"), r = e.data("anchor"), m = C;
            if (c.onSlideLeave) {
                var n = l.find(".slide.active").index(), p;
                p = n == g ? "none" :n > g ? "left" :"right";
                m || b.isFunction(c.onSlideLeave) && c.onSlideLeave.call(this, h, q + 1, n, p);
            }
            e.addClass("active").siblings().removeClass("active");
            "undefined" === typeof r && (r = g);
            l.hasClass("active") && (c.loopHorizontal || (l.find(".controlArrow.prev").toggle(0 != g), 
            l.find(".controlArrow.next").toggle(!e.is(":last-child"))), N(g, r, h));
            c.css3 ? (d = "translate3d(-" + d.left + "px, 0px, 0px)", a.find(".slidesContainer").toggleClass("easing", 0 < c.scrollingSpeed).css(S(d)), 
            setTimeout(function() {
                m || b.isFunction(c.afterSlideLoad) && c.afterSlideLoad.call(this, h, q + 1, r, g);
                s = !1;
        ...
        function T() {
            ...
            b(".section").each(function() {
                ...
                c.verticalCentered && b(this).find(".tableCell").css("height", U(b(this)) + "px");
                ...
                a.length && h(a, a.find(".slide.active"));
            });
        ...
        function aa(a, c) {
            var d = 825, f = a;
            825 > a || 900 > c ? (900 > c && (f = c, d = 900), d = (100 * f / d).toFixed(2), 
            b("body").css("font-size", d + "%")) :b("body").css("font-size", "100%");
        }
        function R(a, e) {
        ...
        function E(a) {
            ...
            if (d.length) var f = a.find(".scrollable").get(0).scrollHeight; else f = a.get(0).scrollHeight, 
            c.verticalCentered && (f = a.find(".tableCell").get(0).scrollHeight);
            b = k - parseInt(b.css("padding-bottom")) - parseInt(b.css("padding-top"));
            f > b ? d.length ? d.css("height", b + "px").parent().css("height", b + "px") :(c.verticalCentered ? a.find(".tableCell").wrapInner('<div class="scrollable" />') :a.wrapInner('<div class="scrollable" />'), 
            a.find(".scrollable").slimScroll({
                height:b + "px",
                size:"10px",
                alwaysVisible:!0
            })) :(a.find(".scrollable").children().first().unwrap().unwrap(), a.find(".slimScrollBar").remove(), 
            a.find(".slimScrollRail").remove());
            a.css("overflow", "");
        }
        function V(a) {
            a.addClass("table").wrapInner('<div class="tableCell" style="height:' + U(a) + 'px;" />');
        }
        function U(a) {
            var b = k;
            if (c.paddingTop || c.paddingBottom) b = a, b.hasClass("section") || (b = a.closest(".section")), 
            a = parseInt(b.css("padding-top")) + parseInt(b.css("padding-bottom")), b = k - a;
            return b;
        }
        function O(a, b) {
            u.toggleClass("easing", b);
            u.css(S(a));
        }
        function I(a, c) {
            "undefined" === typeof c && (c = 0);
            var d = isNaN(a) ? b('[data-anchor="' + a + '"]') :b(".section").eq(a - 1);
            a === v || d.hasClass("active") ? W(d, c) :p(d, function() {
                W(d, c);
            });
        }
        function W(a, b) {
        ...
        function N(a, b, d) {
            var f = "";
            c.anchors.length && (a ? ("undefined" !== typeof d && (f = d), "undefined" === typeof b && (b = a), 
            J = b, location.hash = f + "/" + b) :("undefined" !== typeof a && (J = b), location.hash = d));
        }
        function ca() {
        ...
        function M(a) {
            var b = [];
            window.navigator.msPointerEnabled ? (b.y = a.pageY, b.x = a.pageX) :(b.y = a.touches[0].pageY, 
            b.x = a.touches[0].pageX);
            return b;
        }
        function y(a) {
            c.css3 ? O("translate3d(0px, -" + a + "px, 0px)", !1) :u.css("top", -a);
        }
        function S(a) {
            return {
                "-webkit-transform":a,
        ...
        b.fn.fullpage.setAutoScrolling = function(a) {
            ...
            c.autoScrolling ? (b("html, body").css({
                overflow:"hidden",
                height:"100%"
            }), a.length && y(a.position().top)) :(b("html, body").css({
                overflow:"auto",
                height:"auto"
            }), y(0), b("html, body").scrollTop(a.position().top));
        };
        ...
        b.fn.fullpage.setAllowScrolling = function(a) {
            a ? (b.fn.fullpage.setMouseWheelScrolling(!0), F && (b(document).off("touchstart MSPointerDown").on("touchstart MSPointerDown", $), 
            b(document).off("touchmove MSPointerMove").on("touchmove MSPointerMove", Z))) :(b.fn.fullpage.setMouseWheelScrolling(!1), 
            F && (b(document).off("touchstart MSPointerDown"), b(document).off("touchmove MSPointerMove")));
        };
        b.fn.fullpage.setKeyboardScrolling = function(a) {
            c.keyboardScrolling = a;
        };
        var s = !1, F = navigator.userAgent.match(/(iPhone|iPod|iPad|Android|BlackBerry|Windows Phone)/), u = b(this), k = b(window).height(), t = !1, C = !1, v, J;
        ...
        b(".section").each(function(a) {
            ...
            if (c.navigation) {
                ...
                m.find("ul").append('<li data-tooltip="' + a + '"><a href="#' + g + '"><span></span></a></li>');
            }
            if (0 < f) {
                var g = 100 * f, h = 100 / f;
                ...
                c.slidesNavigation && ba(b(this), f);
                d.each(function(a) {
                    a || 0 != e.find(".slide.active").length || b(this).addClass("active");
                    b(this).css("width", h + "%");
                    c.verticalCentered && V(b(this));
                });
            } else c.verticalCentered && V(b(this));
            ...
            if (a.length && (0 != b(".section.active").index(".section") || 0 == b(".section.active").index(".section") && 0 != a.index())) {
                ...
                h(b(".section.active").find(".slides"), a);
                b.fn.fullpage.setScrollingSpeed(e);
            }
            c.fixedElements && c.css3 && b(c.fixedElements).appendTo("body");
            c.navigation && (m.css("margin-top", "-" + m.height() / 2 + "px"), m.find("li").eq(b(".section.active").index(".section")).find("a").addClass("active"));
            ...
            a.length && (e = b('[data-anchor="' + a + '"]'), !c.animateAnchor && e.length && (y(e.position().top), 
            b.isFunction(c.afterLoad) && c.afterLoad.call(this, a, e.index(".section") + 1), 
            e.addClass("active").siblings().removeClass("active")));
        ...
        b(window).scroll(function(a) {
            if (!c.autoScrolling) {
                ...
                if (!a.hasClass("active")) {
                    var d = b(".section.active").index(".section") + 1;
                    K = !0;
                    var f = G(a);
                    a.addClass("active").siblings().removeClass("active");
                    var g = a.data("anchor");
                    b.isFunction(c.onLeave) && c.onLeave.call(this, d, f);
                    b.isFunction(c.afterLoad) && c.afterLoad.call(this, g, a.index(".section") + 1);
                    Q(g);
                    R(g, 0);
        ...
        b.fn.fullpage.moveSectionDown = function() {
            ...
            (0 < a.length || !a.length && (c.loopBottom || c.continuousVertical)) && p(a, null, !1);
        };
        b.fn.fullpage.moveTo = function(a, c) {
            var d = "", d = isNaN(a) ? b('[data-anchor="' + a + '"]') :b(".section").eq(a - 1);
            "undefined" !== typeof c ? I(a, c) :0 < d.length && p(d);
        };
        b(window).on("hashchange", function() {
            if (!K) {
                var a = window.location.hash.replace("#", "").split("/"), b = a[0], a = a[1], c = "undefined" === typeof v, f = "undefined" === typeof v && "undefined" === typeof a;
                (b && b !== v && !c || f || !s && J != a) && I(b, a);
            }
        });
        b(document).keydown(function(a) {
            if (c.keyboardScrolling && !t) switch (a.which) {
              case 38:
              case 33:
        ...
        var da = "onorientationchange" in window ? "orientationchange" :"resize";
        b(window).bind(da, function() {
            F && T();
        });
...
})(jQuery);/*  |xGv00|591a9ede1db33b516f7912ab9302d432 */